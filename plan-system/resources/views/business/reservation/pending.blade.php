                                            ...
                                            @if ($branch->setting->outside_flg)
                                                <td class="text-center">
                                                    @if ($hour->position == App\RestaurantPositionsEnum::WHOLE->value)
                                                        <span
                                                            class="label label-info">{{ App\RestaurantPositionsEnum::WHOLE->label() }}</span>
                                                    @endif
                                                    @if ($hour->position == App\RestaurantPositionsEnum::INSIDE->value)
                                                        <span
                                                            class="label label-success">{{ App\RestaurantPositionsEnum::INSIDE->label() }}</span>
                                                    @endif
                                                    @if ($hour->position == App\RestaurantPositionsEnum::OUTSIDE->value)
                                                        <span
                                                            class="label label-warning">{{ App\RestaurantPositionsEnum::OUTSIDE->label() }}</span>
                                                    @endif
                                                </td>
                                            @endif
                                            <td class="text-center">
